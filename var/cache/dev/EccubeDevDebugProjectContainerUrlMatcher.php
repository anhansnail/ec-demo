...
class EccubeDevDebugProjectContainerUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($rawPathinfo)
    {
        ...
        elseif (0 === strpos($pathinfo, '/dashboard')) {
            ...
            if (0 === strpos($pathinfo, '/dashboard/s')) {
                // admin_homepage_sale
                if ('/dashboard/sale_chart' === $pathinfo) {
                ...
                if (0 === strpos($pathinfo, '/dashboard/se')) {
                    // admin_homepage_nonstock
                    if ('/dashboard/search_nonstock' === $pathinfo) {
                    ...
                    if ('/dashboard/search_customer' === $pathinfo) {
                    ...
                    if (0 === strpos($pathinfo, '/dashboard/setting/shop')) {
                        // admin_setting_shop_csv
                        if (0 === strpos($pathinfo, '/dashboard/setting/shop/csv') && preg_match('#^/dashboard/setting/shop/csv(?:/(?P<id>\\d+))?$#sD', $pathinfo, $matches)) {
                        ...
                        if (0 === strpos($pathinfo, '/dashboard/setting/shop/delivery')) {
                            // admin_setting_shop_delivery
                            if ('/dashboard/setting/shop/delivery' === $pathinfo) {
                            ...
                            if ('/dashboard/setting/shop/delivery/new' === $pathinfo) {
                            ...
                            if (preg_match('#^/dashboard/setting/shop/delivery/(?P<id>\\d+)/edit$#sD', $pathinfo, $matches)) {
                            ...
                            if (preg_match('#^/dashboard/setting/shop/delivery/(?P<id>\\d+)/delete$#sD', $pathinfo, $matches)) {
                            ...
                            if (preg_match('#^/dashboard/setting/shop/delivery/(?P<id>\\d+)/visibility$#sD', $pathinfo, $matches)) {
                            ...
                            if ('/dashboard/setting/shop/delivery/sort_no/move' === $pathinfo) {
                        ...
                        elseif (0 === strpos($pathinfo, '/dashboard/setting/shop/mail')) {
                            // admin_setting_shop_mail
                            if ('/dashboard/setting/shop/mail' === $pathinfo) {
                            ...
                            if (preg_match('#^/dashboard/setting/shop/mail/(?P<id>\\d+)$#sD', $pathinfo, $matches)) {
                            ...
                            if ('/dashboard/setting/shop/mail/preview' === $pathinfo) {
                        ...
                        elseif (0 === strpos($pathinfo, '/dashboard/setting/shop/payment')) {
                            // admin_setting_shop_payment
                            if ('/dashboard/setting/shop/payment' === $pathinfo) {
                            ...
                            if ('/dashboard/setting/shop/payment/new' === $pathinfo) {
                            ...
                            if (preg_match('#^/dashboard/setting/shop/payment/(?P<id>\\d+)/edit$#sD', $pathinfo, $matches)) {
                            ...
                            if ('/dashboard/setting/shop/payment/image/add' === $pathinfo) {
                            ...
                            if (preg_match('#^/dashboard/setting/shop/payment/(?P<id>\\d+)/delete$#sD', $pathinfo, $matches)) {
                            ...
                            if (preg_match('#^/dashboard/setting/shop/payment/(?P<id>\\d+)/visible$#sD', $pathinfo, $matches)) {
                            ...
                            if ('/dashboard/setting/shop/payment/sort_no/move' === $pathinfo) {
                        ...
                        // admin_setting_shop
                        if ('/dashboard/setting/shop' === $pathinfo) {
                        ...
                        if (0 === strpos($pathinfo, '/dashboard/setting/shop/tax')) {
                            // admin_setting_shop_tax
                            if ('/dashboard/setting/shop/tax' === $pathinfo) {
                            ...
                            if ('/dashboard/setting/shop/tax/new' === $pathinfo) {
                            ...
                            if (preg_match('#^/dashboard/setting/shop/tax/(?P<id>\\d+)/delete$#sD', $pathinfo, $matches)) {
                    ...
                    elseif (0 === strpos($pathinfo, '/dashboard/setting/system')) {
                        // admin_setting_system_authority
                        if ('/dashboard/setting/system/authority' === $pathinfo) {
                        ...
                        if ('/dashboard/setting/system/log' === $pathinfo) {
                        ...
                        if (0 === strpos($pathinfo, '/dashboard/setting/system/masterdata')) {
                            // admin_setting_system_masterdata
                            if ('/dashboard/setting/system/masterdata' === $pathinfo) {
                            ...
                            if (preg_match('#^/dashboard/setting/system/masterdata/(?P<entity>[^/]++)/edit$#sD', $pathinfo, $matches)) {
                            ...
                            if ('/dashboard/setting/system/masterdata/edit' === $pathinfo) {
                        ...
                        elseif (0 === strpos($pathinfo, '/dashboard/setting/system/member')) {
                            // admin_setting_system_member
                            if ('/dashboard/setting/system/member' === $pathinfo) {
                            ...
                            if ('/dashboard/setting/system/member/new' === $pathinfo) {
                            ...
                            if (preg_match('#^/dashboard/setting/system/member/(?P<id>\\d+)/edit$#sD', $pathinfo, $matches)) {
                            ...
                            if (preg_match('#^/dashboard/setting/system/member/(?P<id>\\d+)/up$#sD', $pathinfo, $matches)) {
                            ...
                            if (preg_match('#^/dashboard/setting/system/member/(?P<id>\\d+)/down$#sD', $pathinfo, $matches)) {
                            ...
                            if (preg_match('#^/dashboard/setting/system/member/(?P<id>\\d+)/delete$#sD', $pathinfo, $matches)) {
                        ...
                        if ('/dashboard/setting/system/security' === $pathinfo) {
                        ...
                        if (0 === strpos($pathinfo, '/dashboard/setting/system/system')) {
                            // admin_setting_system_system
                            if ('/dashboard/setting/system/system' === $pathinfo) {
                            ...
                            if ('/dashboard/setting/system/system/phpinfo' === $pathinfo) {
                ...
                elseif (0 === strpos($pathinfo, '/dashboard/shipping')) {
                    // admin_shipping_update_order_status
                    if (preg_match('#^/dashboard/shipping/(?P<id>\\d+)/order_status$#sD', $pathinfo, $matches)) {
                    ...
                    if (preg_match('#^/dashboard/shipping/(?P<id>\\d+)/tracking_number$#sD', $pathinfo, $matches)) {
                    ...
                    // admin_shipping_edit
                    if (preg_match('#^/dashboard/shipping/(?P<id>\\d+)/edit$#sD', $pathinfo, $matches)) {
                    ...
                    if (0 === strpos($pathinfo, '/dashboard/shipping/preview_notify_mail') && preg_match('#^/dashboard/shipping/preview_notify_mail/(?P<id>\\d+)$#sD', $pathinfo, $matches)) {
                    ...
                    if (0 === strpos($pathinfo, '/dashboard/shipping/notify_mail') && preg_match('#^/dashboard/shipping/notify_mail/(?P<id>\\d+)$#sD', $pathinfo, $matches)) {
                ...
                elseif (0 === strpos($pathinfo, '/dashboard/store/plugin')) {
                    if (0 === strpos($pathinfo, '/dashboard/store/plugin/api')) {
                        if (0 === strpos($pathinfo, '/dashboard/store/plugin/api/search')) {
                            // admin_store_plugin_owners_search
                            if ('/dashboard/store/plugin/api/search' === $pathinfo) {
                            ...
                            if (0 === strpos($pathinfo, '/dashboard/store/plugin/api/search/page') && preg_match('#^/dashboard/store/plugin/api/search/page(?:/(?P<page_no>\\d+))?$#sD', $pathinfo, $matches)) {
                        ...
                        if ('/dashboard/store/plugin/api/schema_update' === $pathinfo) {
                        ...
                        if (0 === strpos($pathinfo, '/dashboard/store/plugin/api/install')) {
                            // admin_store_plugin_install_confirm
                            if (preg_match('#^/dashboard/store/plugin/api/install/(?P<id>\\d+)/confirm$#sD', $pathinfo, $matches)) {
                            ...
                            if ('/dashboard/store/plugin/api/install' === $pathinfo) {
                        ...
                        if (0 === strpos($pathinfo, '/dashboard/store/plugin/api/delete') && preg_match('#^/dashboard/store/plugin/api/delete/(?P<id>\\d+)/uninstall$#sD', $pathinfo, $matches)) {
                        ...
                        if (0 === strpos($pathinfo, '/dashboard/store/plugin/api/upgrade')) {
                            // admin_store_plugin_api_upgrade
                            if ('/dashboard/store/plugin/api/upgrade' === $pathinfo) {
                            ...
                            if (preg_match('#^/dashboard/store/plugin/api/upgrade/(?P<id>\\d+)/confirm$#sD', $pathinfo, $matches)) {
                        ...
                        if ('/dashboard/store/plugin/api/update' === $pathinfo) {
                    ...
                    // admin_store_plugin
                    if ('/dashboard/store/plugin' === $pathinfo) {
                    ...
                    if (preg_match('#^/dashboard/store/plugin/(?P<id>\\d+)/update$#sD', $pathinfo, $matches)) {
                    ...
                    if (preg_match('#^/dashboard/store/plugin/(?P<id>\\d+)/enable$#sD', $pathinfo, $matches)) {
                    ...
                    if (preg_match('#^/dashboard/store/plugin/(?P<id>\\d+)/disable$#sD', $pathinfo, $matches)) {
                    ...
                    if (preg_match('#^/dashboard/store/plugin/(?P<id>\\d+)/uninstall$#sD', $pathinfo, $matches)) {
                    ...
                    if ('/dashboard/store/plugin/install' === $pathinfo) {
                    ...
                    if ('/dashboard/store/plugin/authentication_setting' === $pathinfo) {
                ...
                elseif (0 === strpos($pathinfo, '/dashboard/store/template')) {
                    // admin_store_template
                    if ('/dashboard/store/template' === $pathinfo) {
                    ...
                    if (preg_match('#^/dashboard/store/template/(?P<id>\\d+)/download$#sD', $pathinfo, $matches)) {
                    ...
                    if (preg_match('#^/dashboard/store/template/(?P<id>\\d+)/delete$#sD', $pathinfo, $matches)) {
                    ...
                    if ('/dashboard/store/template/install' === $pathinfo) {
            ...
            elseif (0 === strpos($pathinfo, '/dashboard/c')) {
                // admin_change_password
                if ('/dashboard/change_password' === $pathinfo) {
                ...
                if (0 === strpos($pathinfo, '/dashboard/content')) {
                    if (0 === strpos($pathinfo, '/dashboard/content/block')) {
                        // admin_content_block
                        if ('/dashboard/content/block' === $pathinfo) {
                        ...
                        if ('/dashboard/content/block/new' === $pathinfo) {
                        ...
                        if (preg_match('#^/dashboard/content/block/(?P<id>\\d+)/edit$#sD', $pathinfo, $matches)) {
                        ...
                        if (preg_match('#^/dashboard/content/block/(?P<id>\\d+)/delete$#sD', $pathinfo, $matches)) {
                    ...
                    // admin_content_cache
                    if ('/dashboard/content/cache' === $pathinfo) {
                    ...
                    // admin_content_css
                    if ('/dashboard/content/css' === $pathinfo) {
                    ...
                    if (0 === strpos($pathinfo, '/dashboard/content/file_')) {
                        // admin_content_file
                        if ('/dashboard/content/file_manager' === $pathinfo) {
                        ...
                        if ('/dashboard/content/file_view' === $pathinfo) {
                        ...
                        if ('/dashboard/content/file_delete' === $pathinfo) {
                        ...
                        if ('/dashboard/content/file_download' === $pathinfo) {
                    ...
                    // admin_content_js
                    if ('/dashboard/content/js' === $pathinfo) {
                    ...
                    if (0 === strpos($pathinfo, '/dashboard/content/layout')) {
                        // admin_content_layout
                        if ('/dashboard/content/layout' === $pathinfo) {
                        ...
                        if (preg_match('#^/dashboard/content/layout/(?P<id>\\d+)/delete$#sD', $pathinfo, $matches)) {
                        ...
                        if ('/dashboard/content/layout/new' === $pathinfo) {
                        ...
                        if (preg_match('#^/dashboard/content/layout/(?P<id>\\d+)/edit$#sD', $pathinfo, $matches)) {
                        ...
                        if ('/dashboard/content/layout/view_block' === $pathinfo) {
                        ...
                        if (preg_match('#^/dashboard/content/layout/(?P<id>\\d+)/preview$#sD', $pathinfo, $matches)) {
                    ...
                    if ('/dashboard/content/maintenance' === $pathinfo) {
                    ...
                    if (0 === strpos($pathinfo, '/dashboard/content/news')) {
                        // admin_content_news
                        if ('/dashboard/content/news' === $pathinfo) {
                        ...
                        if (0 === strpos($pathinfo, '/dashboard/content/news/page') && preg_match('#^/dashboard/content/news/page(?:/(?P<page_no>\\d+))?$#sD', $pathinfo, $matches)) {
                        ...
                        if ('/dashboard/content/news/new' === $pathinfo) {
                        ...
                        if (preg_match('#^/dashboard/content/news/(?P<id>\\d+)/edit$#sD', $pathinfo, $matches)) {
                        ...
                        if (preg_match('#^/dashboard/content/news/(?P<id>\\d+)/delete$#sD', $pathinfo, $matches)) {
                    ...
                    elseif (0 === strpos($pathinfo, '/dashboard/content/page')) {
                        // admin_content_page
                        if ('/dashboard/content/page' === $pathinfo) {
                        ...
                        if ('/dashboard/content/page/new' === $pathinfo) {
                        ...
                        if (preg_match('#^/dashboard/content/page/(?P<id>\\d+)/edit$#sD', $pathinfo, $matches)) {
                        ...
                        if (preg_match('#^/dashboard/content/page/(?P<id>\\d+)/delete$#sD', $pathinfo, $matches)) {
                ...
                elseif (0 === strpos($pathinfo, '/dashboard/customer')) {
                    // admin_customer
                    if ('/dashboard/customer' === $pathinfo) {
                    ...
                    // admin_customer_page
                    if (0 === strpos($pathinfo, '/dashboard/customer/page') && preg_match('#^/dashboard/customer/page(?:/(?P<page_no>\\d+))?$#sD', $pathinfo, $matches)) {
                    ...
                    if (preg_match('#^/dashboard/customer/(?P<id>\\d+)/resend$#sD', $pathinfo, $matches)) {
                    ...
                    if (preg_match('#^/dashboard/customer/(?P<id>\\d+)/delete$#sD', $pathinfo, $matches)) {
                    ...
                    if ('/dashboard/customer/export' === $pathinfo) {
                    ...
                    if (preg_match('#^/dashboard/customer/(?P<id>\\d+)/delivery/new$#sD', $pathinfo, $matches)) {
                    ...
                    if (preg_match('#^/dashboard/customer/(?P<id>\\d+)/delivery/(?P<did>\\d+)/edit$#sD', $pathinfo, $matches)) {
                    ...
                    if (preg_match('#^/dashboard/customer/(?P<id>\\d+)/delivery/(?P<did>\\d+)/delete$#sD', $pathinfo, $matches)) {
                    ...
                    // admin_customer_new
                    if ('/dashboard/customer/new' === $pathinfo) {
                    ...
                    // admin_customer_edit
                    if (preg_match('#^/dashboard/customer/(?P<id>\\d+)/edit$#sD', $pathinfo, $matches)) {
            ...
            elseif (0 === strpos($pathinfo, '/dashboard/order')) {
                // admin_shipping_csv_import
                if ('/dashboard/order/shipping_csv_upload' === $pathinfo) {
                ...
                if ('/dashboard/order/csv_template' === $pathinfo) {
                ...
                // admin_order_new
                if ('/dashboard/order/new' === $pathinfo) {
                ...
                // admin_order_edit
                if (preg_match('#^/dashboard/order/(?P<id>\\d+)/edit$#sD', $pathinfo, $matches)) {
                ...
                if (0 === strpos($pathinfo, '/dashboard/order/search')) {
                    if (0 === strpos($pathinfo, '/dashboard/order/search/customer/html')) {
                        // admin_order_search_customer_html
                        if ('/dashboard/order/search/customer/html' === $pathinfo) {
                        ...
                        if (0 === strpos($pathinfo, '/dashboard/order/search/customer/html/page') && preg_match('#^/dashboard/order/search/customer/html/page(?:/(?P<page_no>[^/]++))?$#sD', $pathinfo, $matches)) {
                    ...
                    if ('/dashboard/order/search/customer/id' === $pathinfo) {
                    ...
                    if (0 === strpos($pathinfo, '/dashboard/order/search/product')) {
                        // admin_order_search_product
                        if ('/dashboard/order/search/product' === $pathinfo) {
                        ...
                        if (0 === strpos($pathinfo, '/dashboard/order/search/product/page') && preg_match('#^/dashboard/order/search/product/page(?:/(?P<page_no>\\d+))?$#sD', $pathinfo, $matches)) {
                    ...
                    if ('/dashboard/order/search/order_item_type' === $pathinfo) {
                ...
                // admin_order_mail
                if (preg_match('#^/dashboard/order/(?P<id>\\d+)/mail$#sD', $pathinfo, $matches)) {
                ...
                if ('/dashboard/order/mail/view' === $pathinfo) {
                ...
                // admin_order_page
                if (0 === strpos($pathinfo, '/dashboard/order/page') && preg_match('#^/dashboard/order/page(?:/(?P<page_no>\\d+))?$#sD', $pathinfo, $matches)) {
                ...
                if ('/dashboard/order/bulk_delete' === $pathinfo) {
                ...
                if (0 === strpos($pathinfo, '/dashboard/order/export')) {
                    // admin_order_export_order
                    if ('/dashboard/order/export/order' === $pathinfo) {
                    ...
                    if ('/dashboard/order/export/shipping' === $pathinfo) {
                    ...
                    if (0 === strpos($pathinfo, '/dashboard/order/export/pdf')) {
                        // admin_order_export_pdf
                        if ('/dashboard/order/export/pdf' === $pathinfo) {
                        ...
                        if ('/dashboard/order/export/pdf/download' === $pathinfo) {
            ...
            elseif (0 === strpos($pathinfo, '/dashboard/product')) {
                if (0 === strpos($pathinfo, '/dashboard/product/c')) {
                    if (0 === strpos($pathinfo, '/dashboard/product/category')) {
                        // admin_product_category
                        if ('/dashboard/product/category' === $pathinfo) {
                        ...
                        if (preg_match('#^/dashboard/product/category(?:/(?P<parent_id>\\d+))?$#sD', $pathinfo, $matches)) {
                        ...
                        if (preg_match('#^/dashboard/product/category/(?P<id>\\d+)/edit$#sD', $pathinfo, $matches)) {
                        ...
                        if (preg_match('#^/dashboard/product/category/(?P<id>\\d+)/delete$#sD', $pathinfo, $matches)) {
                        ...
                        if ('/dashboard/product/category/sort_no/move' === $pathinfo) {
                        ...
                        if ('/dashboard/product/category/export' === $pathinfo) {
                        ...
                        if ('/dashboard/product/category_csv_upload' === $pathinfo) {
                    ...
                    elseif (0 === strpos($pathinfo, '/dashboard/product/class_category')) {
                        // admin_product_class_category
                        if (preg_match('#^/dashboard/product/class_category/(?P<class_name_id>\\d+)$#sD', $pathinfo, $matches)) {
                        ...
                        if (preg_match('#^/dashboard/product/class_category/(?P<class_name_id>\\d+)/(?P<id>\\d+)/edit$#sD', $pathinfo, $matches)) {
                        ...
                        if (preg_match('#^/dashboard/product/class_category/(?P<class_name_id>\\d+)/(?P<id>\\d+)/delete$#sD', $pathinfo, $matches)) {
                        ...
                        if (preg_match('#^/dashboard/product/class_category/(?P<class_name_id>\\d+)/(?P<id>\\d+)/visibility$#sD', $pathinfo, $matches)) {
                        ...
                        if ('/dashboard/product/class_category/sort_no/move' === $pathinfo) {
                    ...
                    elseif (0 === strpos($pathinfo, '/dashboard/product/class_name')) {
                        // admin_product_class_name
                        if ('/dashboard/product/class_name' === $pathinfo) {
                        ...
                        if (preg_match('#^/dashboard/product/class_name/(?P<id>\\d+)/edit$#sD', $pathinfo, $matches)) {
                        ...
                        if (preg_match('#^/dashboard/product/class_name/(?P<id>\\d+)/delete$#sD', $pathinfo, $matches)) {
                        ...
                        if ('/dashboard/product/class_name/sort_no/move' === $pathinfo) {
                    ...
                    if (0 === strpos($pathinfo, '/dashboard/product/csv_template') && preg_match('#^/dashboard/product/csv_template/(?P<type>\\w+)$#sD', $pathinfo, $matches)) {
                ...
                if ('/dashboard/product/product_csv_upload' === $pathinfo) {
                ...
                if (0 === strpos($pathinfo, '/dashboard/product/product/class')) {
                    // admin_product_product_class
                    if (preg_match('#^/dashboard/product/product/class/(?P<id>\\d+)$#sD', $pathinfo, $matches)) {
                    ...
                    if (preg_match('#^/dashboard/product/product/class/(?P<id>\\d+)/clear$#sD', $pathinfo, $matches)) {
                ...
                // admin_product_page
                if (0 === strpos($pathinfo, '/dashboard/product/page') && preg_match('#^/dashboard/product/page(?:/(?P<page_no>\\d+))?$#sD', $pathinfo, $matches)) {
                ...
                if (0 === strpos($pathinfo, '/dashboard/product/product')) {
                    // admin_product_image_add
                    if ('/dashboard/product/product/image/add' === $pathinfo) {
                    ...
                    if ('/dashboard/product/product/new' === $pathinfo) {
                    ...
                    if (preg_match('#^/dashboard/product/product/(?P<id>\\d+)/edit$#sD', $pathinfo, $matches)) {
                    ...
                    if (preg_match('#^/dashboard/product/product/(?P<id>\\d+)/delete$#sD', $pathinfo, $matches)) {
                    ...
                    if (preg_match('#^/dashboard/product/product/(?P<id>\\d+)/copy$#sD', $pathinfo, $matches)) {
                    ...
                    if (preg_match('#^/dashboard/product/product/(?P<id>\\d+)/display$#sD', $pathinfo, $matches)) {
                ...
                if (0 === strpos($pathinfo, '/dashboard/product/classes') && preg_match('#^/dashboard/product/classes/(?P<id>\\d+)/load$#sD', $pathinfo, $matches)) {
                ...
                if ('/dashboard/product/export' === $pathinfo) {
                ...
                if (0 === strpos($pathinfo, '/dashboard/product/bulk/product-status') && preg_match('#^/dashboard/product/bulk/product\\-status/(?P<id>\\d+)$#sD', $pathinfo, $matches)) {
                ...
                if (0 === strpos($pathinfo, '/dashboard/product/tag')) {
                    // admin_product_tag
                    if ('/dashboard/product/tag' === $pathinfo) {
                    ...
                    if (preg_match('#^/dashboard/product/tag/(?P<id>\\d+)/delete$#sD', $pathinfo, $matches)) {
                    ...
                    if ('/dashboard/product/tag/sort_no/move' === $pathinfo) {
        ...
        // demo1
        if ('/demo1' === $pathinfo) {
            $ret = array (  '_controller' => 'Customize\\Controller\\OverwriteExistRoutingController::testMethod',  '_route' => 'demo1',);
            $requiredSchemes = array (  'https' => 0,  'http' => 1,);
            $hasRequiredScheme = isset($requiredSchemes[$context->getScheme()]);
            if (!in_array($canonicalMethod, ['GET'])) {
                if ($hasRequiredScheme) {
            ...
            if (!$hasRequiredScheme) {
                ...
                return array_replace($ret, $this->redirect($rawPathinfo, 'demo1', key($requiredSchemes)));
            }
        ...
        elseif (0 === strpos($pathinfo, '/c')) {
            ...
            // controller
            if ('/controller' === $pathinfo) {
                $ret = array (  '_controller' => 'Customize\\Controller\\CreateCtrNoScreenController::testMethod',  '_route' => 'controller',);
                $requiredSchemes = array (  'https' => 0,  'http' => 1,);
                $hasRequiredScheme = isset($requiredSchemes[$context->getScheme()]);
                if (!in_array($canonicalMethod, ['GET'])) {
                    if ($hasRequiredScheme) {
                ...
                if (!$hasRequiredScheme) {
                    ...
                    return array_replace($ret, $this->redirect($rawPathinfo, 'controller', key($requiredSchemes)));
                }
        ...
        // get_shop_name
        if ('/get_shop_name' === $pathinfo) {
            $ret = array (  '_controller' => 'Customize\\Controller\\AddAServiceWithoutAbstractClassController::testMethod',  '_route' => 'get_shop_name',);
            $requiredSchemes = array (  'https' => 0,  'http' => 1,);
            $hasRequiredScheme = isset($requiredSchemes[$context->getScheme()]);
            if (!in_array($canonicalMethod, ['GET'])) {
                if ($hasRequiredScheme) {
            ...
            if (!$hasRequiredScheme) {
                ...
                return array_replace($ret, $this->redirect($rawPathinfo, 'get_shop_name', key($requiredSchemes)));
            }
        ...
        elseif (0 === strpos($pathinfo, '/sample')) {
            // customize_addmanagementscreenrouting_testmethod
            if ('/sample' === $pathinfo) {
                $ret = array (  '_controller' => 'Customize\\Controller\\AddManagementScreenRoutingController::testMethod',  '_route' => 'customize_addmanagementscreenrouting_testmethod',);
                $requiredSchemes = array (  'https' => 0,  'http' => 1,);
                $hasRequiredScheme = isset($requiredSchemes[$context->getScheme()]);
                if (!in_array($canonicalMethod, ['GET'])) {
                    if ($hasRequiredScheme) {
                    ...
                    goto not_customize_addmanagementscreenrouting_testmethod;
                }
                if (!$hasRequiredScheme) {
                    if ('GET' !== $canonicalMethod) {
                        goto not_customize_addmanagementscreenrouting_testmethod;
                    ...
                    return array_replace($ret, $this->redirect($rawPathinfo, 'customize_addmanagementscreenrouting_testmethod', key($requiredSchemes)));
                }

                return $ret;
            }
            not_customize_addmanagementscreenrouting_testmethod:

            // customize_demoparameterfromurl_testmethod
            if (preg_match('#^/sample/(?P<id>[^/]++)$#sD', $pathinfo, $matches)) {
                $ret = $this->mergeDefaults(array_replace($matches, ['_route' => 'customize_demoparameterfromurl_testmethod']), array (  '_controller' => 'Customize\\Controller\\DemoParameterFromUrlController::testMethod',));
                $requiredSchemes = array (  'https' => 0,  'http' => 1,);
                $hasRequiredScheme = isset($requiredSchemes[$context->getScheme()]);
                if (!in_array($canonicalMethod, ['GET'])) {
                    if ($hasRequiredScheme) {
                    ...
                    goto not_customize_demoparameterfromurl_testmethod;
                }
                if (!$hasRequiredScheme) {
                    if ('GET' !== $canonicalMethod) {
                        goto not_customize_demoparameterfromurl_testmethod;
                    ...
                    return array_replace($ret, $this->redirect($rawPathinfo, 'customize_demoparameterfromurl_testmethod', key($requiredSchemes)));
                }

                return $ret;
            }
            not_customize_demoparameterfromurl_testmethod:

            // sample_page
            if (0 === strpos($pathinfo, '/sample/url') && preg_match('#^/sample/url/(?P<id>[^/]++)$#sD', $pathinfo, $matches)) {
                $ret = $this->mergeDefaults(array_replace($matches, ['_route' => 'sample_page']), array (  '_controller' => 'Customize\\Controller\\LinkToAddRouterController::testMethod',));
                $requiredSchemes = array (  'https' => 0,  'http' => 1,);
                $hasRequiredScheme = isset($requiredSchemes[$context->getScheme()]);
                if (!in_array($canonicalMethod, ['GET'])) {
                    if ($hasRequiredScheme) {
                ...
                if (!$hasRequiredScheme) {
                    ...
                    return array_replace($ret, $this->redirect($rawPathinfo, 'sample_page', key($requiredSchemes)));
                }
        ...
        elseif (0 === strpos($pathinfo, '/products')) {
            ...
            if ('/products' === $pathinfo) {
                $ret = array (  '_controller' => 'Customize\\Controller\\UseServicesController::testDemoEntity',  '_route' => 'products',);
                $requiredSchemes = array (  'https' => 0,  'http' => 1,);
                $hasRequiredScheme = isset($requiredSchemes[$context->getScheme()]);
                if (!in_array($canonicalMethod, ['GET'])) {
                    if ($hasRequiredScheme) {
                ...
                if (!$hasRequiredScheme) {
                    ...
                    return array_replace($ret, $this->redirect($rawPathinfo, 'products', key($requiredSchemes)));
                }
        ...
        // update_entity
        if ('/update_entity' === $pathinfo) {
            $ret = array (  '_controller' => 'Customize\\Controller\\UpdateEntityController::index',  '_route' => 'update_entity',);
            $requiredSchemes = array (  'https' => 0,  'http' => 1,);
            $hasRequiredScheme = isset($requiredSchemes[$context->getScheme()]);
            if (!in_array($canonicalMethod, ['GET'])) {
                if ($hasRequiredScheme) {
            ...
            if (!$hasRequiredScheme) {
                ...
                return array_replace($ret, $this->redirect($rawPathinfo, 'update_entity', key($requiredSchemes)));
            }
        ...
        if ('/redirect' === $pathinfo) {
            $ret = array (  '_controller' => 'Customize\\Controller\\RedirectToRouteController::test',  '_route' => 'redirect',);
            $requiredSchemes = array (  'https' => 0,  'http' => 1,);
            $hasRequiredScheme = isset($requiredSchemes[$context->getScheme()]);
            if (!in_array($canonicalMethod, ['GET'])) {
                if ($hasRequiredScheme) {
            ...
            if (!$hasRequiredScheme) {
                ...
                return array_replace($ret, $this->redirect($rawPathinfo, 'redirect', key($requiredSchemes)));
            }
