...
// Returns the public 'Customize\Controller\UpdateEntityController' shared autowired service.
...
include_once $this->targetDirs[3].'/app/Customize/Controller/UpdateEntityController.php';

$this->services['Customize\\Controller\\UpdateEntityController'] = $instance = new \Customize\Controller\UpdateEntityController(${($_ = isset($this->services['Eccube\\Repository\\ProductRepository']) ? $this->services['Eccube\\Repository\\ProductRepository'] : $this->getProductRepositoryService()) && false ?: '_'});
